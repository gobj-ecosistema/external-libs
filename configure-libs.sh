...
echo "===================== OPENSSL ======================="
#     --api=1.1.0 \
cd build/openssl-OpenSSL_1_1_1i
./config \
...
./configure \
    ...
    --with-openssl=/yuneta/development/yuneta/^gobj-ecosistema/external-libs/build/openssl-OpenSSL_1_1_1i
make
make install
cd ../..
